...
def evaluate(model, path, iou_thres, conf_thres, nms_thres, img_size, batch_size):
    ...
    print("Total Inference time is ", detection_time+non_max_suppression_time, "Average per image is ", ((detection_time+non_max_suppression_time)/len(dataloader)).microseconds/1000, "ms")
