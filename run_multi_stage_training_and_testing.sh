...
python3 ada_train.py --model_def config/yolov3-ada6.cfg --data_config config/coco.data --clusters_path clusters_sub.data --epochs 100
...
python3 train.py --model_def config/yolov3-tiny6.cfg --data_config config/coco.data --epochs 100
